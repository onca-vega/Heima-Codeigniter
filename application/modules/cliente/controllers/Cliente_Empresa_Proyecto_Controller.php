...
class Cliente_Empresa_Proyecto_Controller extends Oauth2_Controller {
	public function cliente_empresa_proyectos_get($id_cliente, $id_empresa){
		$this->_authenticate();
	...
	public function cliente_empresa_proyecto_get($id_cliente, $id_empresa, $id){
		$this->_authenticate();
		$filtro = new Proyecto('select');
		$filtro->setData('id_cliente', $id_cliente, ['where' => true]);
		$filtro->setData('id_empresa', $id_empresa, ['where' => true]);
	...
	public function cliente_empresa_proyectos_post($id_cliente, $id_empresa){
		$this->_authenticate();
	    ...
	    $filtro->setData('id_cliente', $id_cliente);
			...
			if($id)
		      ...
		      'id' => $id,
				...
				$this->response([
					[
						'message' => "La combinación cliente '".$id_cliente."' empresa '".$id_empresa."' no es posible"
					]
				], 422);
	}

	public function cliente_empresa_proyecto_patch($id_cliente, $id_empresa, $id){
		$this->_authenticate();
		$ahora = date('Y-m-d H:i:s');
	...
	public function cliente_empresa_proyecto_delete($id_cliente, $id_empresa, $id){
		$this->_authenticate();
